...
public class TencentInfrastructureProviderConfig {
  ...
  public TencentInfrastructureProviderConfig(ObjectMapper objectMapper, Registry registry) {
            ...
            region -> {
              agents.add(
                  new TencentServerGroupCachingAgent(
                      credential, objectMapper, registry, (region).getName()));

              agents.add(
                  new TencentInstanceTypeCachingAgent(
                      credential, objectMapper, (region).getName()));

              agents.add(
                  new TencentKeyPairCachingAgent(credential, objectMapper, (region).getName()));

              agents.add(
                  new TencentImageCachingAgent(credential, objectMapper, (region).getName()));

              agents.add(
                  new TencentInstanceCachingAgent(credential, objectMapper, (region).getName()));
              ...
              agents.add(
                  new TencentNetworkCachingAgent(credential, objectMapper, (region).getName()));

              agents.add(
                  new TencentSubnetCachingAgent(credential, objectMapper, (region).getName()));
